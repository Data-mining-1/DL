...
def test():
    ...
    # Best 모델 경로
    best_model_path = os.path.join(logging_config['log_dir'], '20241201-142117', 'best_model_fold_2.pth')
    ...
    print("\nTest Results:")
    print(f"Accuracy: {test_metrics['accuracy']:.8f}")
    print(f"Precision: {test_metrics['precision']:.8f}")
    print(f"Recall: {test_metrics['recall']:.8f}")
    print(f"F1-Score: {test_metrics['f1']:.8f}")
    print(f"AUC: {test_metrics['auc']:.8f}")
